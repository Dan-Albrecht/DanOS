...
try {
    ...
    nasm.exe .\bootloaderStage1.asm -Werror -DMAX_SECTOR_READ_COUNT="$maxSectorReadCount" -DFULL_SECTOR_BLOCKS="$fullBlocks" -DREMAINING_SECTORS="$remainingSectors" -DSTAGE2_ADDRESS="$addressToLoadTo" -f bin -o .\bootloaderStage1.bin
